...
public:
    ...
    static void setStaticValue(int val) { staticValue = val; }
...
REFLECT_TYPE(TestClasses::SimpleClass)
    .field("publicValue", &TestClasses::SimpleClass::publicValue)
    .field("privateValue", &TestClasses::SimpleClass::privateValue)
    .field("constValue", &TestClasses::SimpleClass::constValue)
    .field("name", &TestClasses::SimpleClass::name)
    .field("staticValue", &TestClasses::SimpleClass::staticValue)
